...
class Ui_DialogCopySourceDataToDatabase(object):
    ...
    def retranslateUi(self, DialogCopySourceDataToDatabase):
        ...
        self.label_6.setText(_translate("DialogCopySourceDataToDatabase", "Kohde skeema ja taulu"))
        self.label_3.setText(_translate("DialogCopySourceDataToDatabase", "Kohdetaulun kenttä"))
