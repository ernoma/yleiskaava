...
class Ui_DialogCopySourceDataToDatabase(object):
    ...
    def retranslateUi(self, DialogCopySourceDataToDatabase):
        ...
        self.label_6.setText(_translate("DialogCopySourceDataToDatabase", "Kohdekarttataso (kaavaobjekti)"))
        self.label_3.setText(_translate("DialogCopySourceDataToDatabase", "Kohdekarttatason kenttä"))
