...
class YleiskaavaUtils:
    ...
    LAND_USE_CLASSIFICATION_ABBREVIATIONS = [
        { "plan_numbers": ["yk047"], "name": "ASUMISEN ALUE, 2040", "abbreviation": "A" },
        { "plan_numbers": ["yk047", "yk049", "yk050"], "name": "ASUMISEN ALUE", "abbreviation": "A" },
        { "plan_numbers": ["yk047"], "name": "ASUMISEN JA VIRKISTYKSEN SEKOITTUNUT ALUE, 2040", "abbreviation": "A/V" },
        { "plan_numbers": ["yk047", "yk049", "yk050"], "name": "ASUMISEN JA VIRKISTYKSEN SEKOITTUNUT ALUE", "abbreviation": "A/V" },
        { "plan_numbers": ["yk047"], "name": "KESKUSPUISTOVERKOSTO, 2040", "abbreviation": "V" },
        { "plan_numbers": ["yk047", "yk049"], "name": "KESKUSPUISTOVERKOSTO", "abbreviation": "V" },
        { "plan_numbers": ["yk050"], "name": "VIRKISTYSALUE", "abbreviation": "V" },
        { "plan_numbers": ["yk047"], "name": "KESKUSTATOIMINTOJEN ALUE, 2040", "abbreviation": "C" },
        { "plan_numbers": ["yk047", "yk049"], "name": "KESKUSTATOIMINTOJEN ALUE", "abbreviation": "C" },
        # { "plan_numbers": ["yk047"], "name": "TÄYDENTYVÄ KESKUSTA, 2040", "abbreviation": "C-1" },
        # { "plan_numbers": ["yk047"], "name": "TÄYDENTYVÄ KESKUSTA", "abbreviation": "C-1" },
        # { "plan_numbers": ["yk047"], "name": "UUDISTUVA KESKUSTA, 2040", "abbreviation": "C-2" },
        # { "plan_numbers": ["yk047"], "name": "UUDISTUVA KESKUSTA", "abbreviation": "C-2" },
        # { "plan_numbers": ["yk047"], "name": "LAAJENTUVA KESKUSTA, 2040", "abbreviation": "C-3" },
        # { "plan_numbers": ["yk047"], "name": "LAAJENTUVA KESKUSTA", "abbreviation": "C-3" },
        # { "plan_numbers": ["yk049"], "name": "ETELÄÄN LAAJENTUVA YDINKESKUSTA", "abbreviation": "C-4" },
        { "plan_numbers": ["yk047"], "name": "KESKUSTATOIMINTOJEN JA VIRKISTYKSEN SEKOITTUNUT ALUE, 2040", "abbreviation": "C/V" },
        { "plan_numbers": ["yk047", "yk049"], "name": "KESKUSTATOIMINTOJEN JA VIRKISTYKSEN SEKOITTUNUT ALUE", "abbreviation": "C/V" },
        { "plan_numbers": ["yk047"], "name": "LOMA-ASUNTOALUE, 2040", "abbreviation": "RA" },
        { "plan_numbers": ["yk047", "yk049"], "name": "LOMA-ASUNTOALUE", "abbreviation": "RA" },
        { "plan_numbers": ["yk047"], "name": "LUONNONSUOJELUALUE TAI -KOHDE, 2040", "abbreviation": "SL" },
        { "plan_numbers": ["yk047", "yk049", "yk050"], "name": "LUONNONSUOJELUALUE TAI -KOHDE", "abbreviation": "SL" },
        { "plan_numbers": ["yk047"], "name": "PALVELUJEN JA TYÖPAIKKOJEN SEKOITTUNUT ALUE, 2040", "abbreviation": "P/T" },
        { "plan_numbers": ["yk047"], "name": "PALVELUJEN JA TYÖPAIKKOJEN SEKOITTUNUT ALUE", "abbreviation": "P/T" },
        { "plan_numbers": ["yk049"], "name": "PALVELUJEN JA TYÖPAIKKOJEN SEKOITTUNUT ALUE TAI KOHDE", "abbreviation": "P/T" },
        { "plan_numbers": ["yk047"], "name": "PUOLUSTUSVOIMIEN ALUE, 2040", "abbreviation": "EP" },
        { "plan_numbers": ["yk047", "yk049"], "name": "PUOLUSTUSVOIMIEN ALUE", "abbreviation": "EP" },
        { "plan_numbers": ["yk047"], "name": "TYÖPAIKKOJEN JA ELINKEINOJEN ALUE, 2040", "abbreviation": "T" },
        { "plan_numbers": ["yk047"], "name": "TYÖPAIKKOJEN JA ELINKEINOJEN ALUE", "abbreviation": "T" },
        { "plan_numbers": ["yk049", "yk050"], "name": "TEOLLISUUS- JA TUOTANTOTOIMINTOJEN ALUE", "abbreviation": "T" },
        { "plan_numbers": ["yk047"], "name": "TYÖPAIKKOJEN JA ELINKEINOJEN ALUE, JOLLA YMPÄRISTÖ ASETTAA TOIMINNAN LAADULLE ERITYISIÄ VAATIMUKSIA, 2040", "abbreviation": "TY" },
        { "plan_numbers": ["yk047"], "name": "TYÖPAIKKOJEN JA ELINKEINOJEN ALUE, JOLLA YMPÄRISTÖ ASETTAA TOIMINNAN LAADULLE ERITYISIÄ VAATIMUKSIA", "abbreviation": "TY" },
        ...
        { "plan_numbers": ["yk047"], "name": "VESIALUE, 2040", "abbreviation": "W" },
        { "plan_numbers": ["yk047", "yk049", "yk050"], "name": "VESIALUE", "abbreviation": "W" },
        { "plan_numbers": ["yk047"], "name": "YHTEISÖJEN LOMA-ASUNTOALUE, 2040", "abbreviation": "R" },
        { "plan_numbers": ["yk047", "yk049"], "name": "YHTEISÖJEN LOMA-ASUNTOALUE", "abbreviation": "R" },
        { "plan_numbers": ["yk047"], "name": "ALUE, JOLLE SAA SIJOITTAA SEUDULLISTA PALJON TILAA VAATIVAA KAUPPAA, 2040", "abbreviation": "P" },
        { "plan_numbers": ["yk047"], "name": "ALUE, JOLLE SAA SIJOITTAA SEUDULLISTA PALJON TILAA VAATIVAA KAUPPAA", "abbreviation": "P" }#,
        # { "plan_numbers": ["yk047"], "name": "VAK-RATAPIHA", "abbreviation": "!" },
        # { "plan_numbers": ["yk047"], "name": "OHJEELLINEN LIIKENNEVERKON KEHITTÄMISEN KOHDEALUE", "abbreviation": "lvk" },
        # { "plan_numbers": ["yk047"], "name": "OHJEELLINEN KESKUSPUISTOVERKOSTON KEHITTÄMISTARVEALUE", "abbreviation": "vkk" }
    ...
    def getWidgetForSpatialFeatureFieldType(self, fieldTypeName, fieldName):
        ...
        if fieldTypeName == 'String' or fieldTypeName == 'Int' or fieldTypeName == 'Double' or fieldTypeName == 'LongLong':
            ...
            values = []
            for item in self.yleiskaavaDatabase.getCodeListValuesForPlanObjectField(fieldName):
                if item is not None:
